...
import { getNetworkInfo, troubleshootConnection, generateQRCode } from './network.js';
import archiver from 'archiver';
export async function createServer(uploadDir, port) {
    const app = new Hono();
...
export async function startServer(uploadDir, port) {
